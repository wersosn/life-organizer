...
describe("todoApi", () => {
    ...
    it("updateTodo sends a PUT request to the correct endpoint with the payload", async () => {
    ...
    it("deleteTodo calls DELETE on the correct endpoint", async () => {
    ...
    it("completeTodo calls PATCH on the correct endpoint", async () => {
