...
import { View, Text, useColorScheme, TextInput, KeyboardAvoidingView, ScrollView, Platform, Pressable, Switch } from "react-native";
                        ...
                        {FREQUENCY_OPTIONS.map(option => {
                            ...
                            return (
                                ...
                                >
                                    <Text
                                        style={{
                                            color: isSelected ? "#f5f5f5" : isDark ? "#ccc" : "#333",
                                            fontWeight: "600",
                                        }}
                                    >
