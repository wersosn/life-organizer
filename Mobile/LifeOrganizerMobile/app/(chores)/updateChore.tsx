import { ChoreFrequency, ChoreCategory } from "@/types/chore";
...
import { updateChore } from "@/api/choresApi";
...
export default function UpdateChoreScreen() {
    ...
    const [frequencyUnit, setFrequencyUnit] = useState<ChoreFrequency>(Number(params.frequencyUnit) as ChoreFrequency);
    const [frequencyValue, setFrequencyValue] = useState(params.frequencyValue as string);
