...
namespace LifeOrganizer.Application.Finances.Commands.Budget.GetBudgetWithUsage
{
    public class GetBudgetWithUsageHandler : IRequestHandler<GetBudgetWithUsageQuery, List<BudgetUsageDto>>
    {
        ...
        public GetBudgetWithUsageHandler(IApplicationDbContext context, ICurrentUserService currentUser, ICacheService cacheService)
        {
            _context = context;
        ...
        {
            var cacheKey = CacheKeys.BudgetsUsage(_currentUser.UserId, request.Year, request.Month);
